...
"""
        ...
        with open(file_path, 'w', encoding='utf-8') as f:
            f.write(template)
        print(f"[INFO] Created style template: {file_path}")
...
"""
        ...
        with open(file_path, 'w', encoding='utf-8') as f:
            f.write(template)
        print(f"[INFO] Created module template: {file_path}")
    ...
    def test_basic_framework(self) -> bool:
        ...
        try:
            ...
            if success:
                print("[INFO] ✓ Basic framework builds successfully")
                self.build_log.append("Basic framework: SUCCESS")
            else:
                print("[INFO] ✗ Basic framework build failed")
                print("Error log:")
    ...
    def test_modules_incrementally(self) -> Dict[str, bool]:
        ...
        try:
            for i, module_file in enumerate(module_files, 1):
                ...
                if success:
                    print(f"[INFO] ✓ {module_name} builds successfully")
                    self.build_log.append(f"{module_name}: SUCCESS")
                else:
                    print(f"[INFO] ✗ {module_name} caused build failure")
