...
def check_file_changes(base_branch="main"):
    ...
    # Try different base branch options using batched git rev-parse for optimal performance
    ...
    if filtered_options:
        # Run git rev-parse for all filtered options at once (batched approach)
