\section{\texorpdfstring{\textbf{🛑 TOOL 22 -- SAFE-WORDS  \&  SIGNALSYSTEME (CTMM-MODUL)}{🛑 TOOL 22 -- SAFE-WORDS  \&  SIGNALSYSTEME (CTMM-MODUL)}
\label{tool-22-safe-words-signalsysteme-ctmm-modul}
