...
% Optional: Include converted therapy materials (uncomment to use)
% Note: These files may require LaTeX escaping fixes before inclusion
% Use: python3 fix_latex_escaping.py converted/ to fix any over-escaping issues
%\newpage
%\part*{CONVERTED THERAPY MATERIALS}
%\addcontentsline{toc}{part}{Converted Therapy Materials}
