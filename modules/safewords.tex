\section*{\texorpdfstring{\textcolor{ctmmRed}{\faStop~Safe-Words \& Signalsysteme}}{Safe-Words \& Signalsysteme}}
\label{sec:safewords}
\addcontentsline{toc}{section}{Safe-Words \& Signalsysteme}

\begin{quote}
\textbf{\textcolor{ctmmRed}{Worum geht's hier -- für Freunde?}}\\
Safe-Words sind vereinbarte Codes oder Zeichen, die sofort signalisieren: [SYM]Ich kann nicht mehr", [SYM]Ich brauch Ruhe" oder [SYM]Stopp -- das wird mir zu viel". Sie schützen vor Eskalation, Überforderung, Rückzug oder Missverständnissen -- ohne viele Worte.
\end{quote}
...
\hline
[SYM]Orange" & Warnstufe -- ich werde gleich überfordert & Bei Stress, lautem Ton, innerem Rückzug \\
\hline
[SYM]Kristall" & Stopp -- bitte sofort aufhören & Bei Eskalation, Überforderung, Trigger \\
\hline
Handzeichen (offen) & Ich will reden, aber schaff's nicht & Bei Freeze, Erstarrung, Nonverbales \\
\hline
[SYM]Lagerfeuer" & 5min in den Arm nehmen, ohne zu reden & Wenn ich Nähe brauche (Angst, Frieden) \\
\hline
\end{tabular}
\end{center}
\end{ctmmRedBox}
...
\begin{itemize}
  ...
  \item \textbf{Lautstärke-Code} (Musikart, Kopfhörer sichtbar = [SYM]Bitte in Ruhe lassen")
\end{itemize}
