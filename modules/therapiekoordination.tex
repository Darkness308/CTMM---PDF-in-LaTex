...
\hline
\textbf{Psychotherapeut:} & \ctmmTextField[4cm]{}{therapist_psycho_mm} & PTBS, Borderline, ADHS \\
\hline
\textbf{Neurologe:} & \ctmmTextField[4cm]{}{therapist_neuro_mm} & Epilepsie, post-OP Betreuung \\
\hline
\textbf{DBT-Spezialist:} & \ctmmTextField[4cm]{}{therapist_dbt_mm} & Skills-Training, Emotionsregulation \\
\hline
\textbf{Trauma-Experte:} & \ctmmTextField[4cm]{}{therapist_trauma_mm} & KPTBS, Dissoziation \\
\hline
\textbf{Hausarzt:} & \ctmmTextField[4cm]{}{therapist_gp_mm} & Medikation, Koordination \\
\hline
\end{tabular}
\end{ctmmPurpleBox}
...
\textbf{Letzte Kontrolle:} \ctmmTextField[4cm]{}{neuro_last_mm} \\[0.3cm]
\textbf{Epilepsie-Medikation:} \ctmmTextField[6cm]{}{neuro_med_mm} \\[0.3cm]
...
\ctmmCheckBox{neuro_cognition}{Kognitive Funktion} \quad \ctmmCheckBox{neuro_other}{Andere:} \ctmmTextField[3cm]{}{neuro_other_mm}
\end{ctmmOrangeBox}
