...
2. \textbf{Wirksamkeit:} Hat es geholfen? (1-10)\\
\ctmmTextField[3cm]{}{daily\_mm\\[0.3cm]

3. \textbf{Anpassung:} Eine kleine Verbesserung für morgen?\\
\ctmmTextField[10cm]{}{daily\_mm\\[0.5cm]
>>>>>>> pr-653
...
=======
\ctmmTextField[10cm]{}{week\_mm\\[0.3cm]

\textbf{Ein Erfolg dieser Woche (egal wie klein):}\\
\ctmmTextField[10cm]{}{week\_mm
>>>>>>> pr-653
\end{ctmmYellowBox}
...
=======
\textbf{Datum:} \ctmmTextField[3cm]{}{success\_mm \quad \textbf{Kategorie:} \ctmmCheckBox{cat_micro}{Mikro} \ctmmCheckBox{cat_breakthrough}{Durchbruch} \ctmmCheckBox{cat_surprise}{Überraschung}\\[0.3cm]
>>>>>>> pr-653
...
=======
\textbf{Früher:} \ctmmTextField[5cm]{}{success_before} \textbf{Heute:} \ctmmTextField[5cm]{}{success\_mm\\[0.3cm]
>>>>>>> pr-653
...
=======
\ctmmTextField[10cm]{}{success_key\_mm
>>>>>>> pr-653
\end{ctmmGreenBox}
...
=======
\faThumbtack~\textbf{Unklar:} \ctmmTextField[8cm]{}{feedback\_mm\\
\faTimes~\textbf{Funktioniert nicht:} \ctmmTextField[8cm]{}{feedback\_mm\\
\faPlus~\textbf{Fehlt:} \ctmmTextField[8cm]{}{feedback\_mm\\
\faStar~\textbf{Besonders hilfreich:} \ctmmTextField[8cm]{}{feedback\_mm\\[0.3cm]
>>>>>>> pr-653
...
=======
\ctmmTextField[10cm]{}{desired\_mm
>>>>>>> pr-653
\end{ctmmOrangeBox}
