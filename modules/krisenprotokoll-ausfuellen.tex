...
\ctmmTextArea[14cm]{4cm}{crisis_trigger}{Was hat die Krise ausgelöst?}

\textbf{Verlauf der Krise:} \\
\ctmmTextArea[14cm]{5cm}{crisis_course}{Beschreibung des Krisenverlaufs}
...
\ctmmTextArea[14cm]{4cm}{crisis_what_helped}{Welche Maßnahmen waren erfolgreich?}

\textbf{Was hat nicht geholfen?} \\
\ctmmTextArea[14cm]{3cm}{crisis_what_not_helped}{Welche Strategien waren ineffektiv?}
...
\ctmmTextArea[14cm]{4cm}{crisis_learnings}{Was haben wir aus dieser Krise gelernt?}

\textbf{Trigger-Analyse:} \\
\ctmmTextArea[14cm]{3cm}{crisis_trigger_analysis}{Wie können wir ähnliche Trigger in Zukunft vermeiden?}

\textbf{Präventionsmaßnahmen:} \\
\ctmmTextArea[14cm]{3cm}{crisis_prevention}{Welche Maßnahmen setzen wir zur Prävention um?}
...
\ctmmTextArea[14cm]{2cm}{crisis_action_immediate}{}

\textbf{Kurzfristig (nächste Woche):} \\  
\ctmmTextArea[14cm]{2cm}{crisis_action_short}{}

\textbf{Mittelfristig (nächster Monat):} \\
\ctmmTextArea[14cm]{2cm}{crisis_action_medium}{}

\textbf{Langfristig (nächste 3 Monate):} \\
\ctmmTextArea[14cm]{2cm}{crisis_action_long}{}
...
\ctmmTextArea[14cm]{2cm}{crisis_additional_notes}{}
