...
\ctmmTextArea[14cm]{4}{}{Was hat die Krise ausgelöst?}

\textbf{Verlauf der Krise:} \\
\ctmmTextArea[14cm]{5}{}{Beschreibung des Krisenverlaufs}
...
\ctmmTextArea[14cm]{4}{}{Welche Maßnahmen waren erfolgreich?}

\textbf{Was hat nicht geholfen?} \\
\ctmmTextArea[14cm]{3}{}{Welche Strategien waren ineffektiv?}
...
\ctmmTextArea[14cm]{4}{}{Was haben wir aus dieser Krise gelernt?}

\textbf{Trigger-Analyse:} \\
\ctmmTextArea[14cm]{3}{}{Wie können wir ähnliche Trigger in Zukunft vermeiden?}

\textbf{Präventionsmaßnahmen:} \\
\ctmmTextArea[14cm]{3}{}{Welche Maßnahmen setzen wir zur Prävention um?}
