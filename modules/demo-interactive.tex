...
\vspace{1cm}
\begin{center}
\textit{\textcolor{ctmmGreen}{\faCheckCircle~Demo abgeschlossen} | \textcolor{ctmmBlue}{\faHome~Zurück zu} \ctmmRef{sec:navigation}{Navigation} | \textcolor{ctmmPurple}{\faChartLine~Weiter zu} \ctmmRef{sec:feedback}{Selbstreflexion}}
\end{center}
