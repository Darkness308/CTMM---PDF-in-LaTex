...
\begin{itemize}
  \item \texttt{Kap. 2.5} $\rightarrow$ Selbstwahrnehmung \& Antrieb
  \item \texttt{Kap. 3.2} $\rightarrow$ Isolation \& Rückzug
  \item \texttt{Kap. 4.4} $\rightarrow$ Überforderung, Erschöpfung \& Schutz
  \item \texttt{Kap. 5.2/5.3} $\rightarrow$ Trigger-Frühzeichen \& Matching
\end{itemize}
