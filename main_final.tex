...
\hypersetup{
  colorlinks=false,
  pdfborder={0 0 0},
  pdftitle={CTMM-System - CI Build Target},
  pdfauthor={CTMM-Team},
...
\title{%
  ...
  \vspace{0.3cm}
  {\small\textcolor{gray}{CI Build Target}}
}
\author{CTMM-Team}
\date{\today}
\maketitle
...
% Module einbinden - Alle Module für CI/CD-Tests
...
\newpage
\section*{\textcolor{ctmmBlue}{CI/CD Build Information}}
\addcontentsline{toc}{section}{CI/CD Build Information}

\begin{center}
\textit{This document was built as part of the automated CI/CD pipeline.}\\
\textit{Build completed successfully on \today.}
\end{center}
