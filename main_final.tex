...
% This file is used for CI/CD builds to ensure clean, reproducible builds
% It includes all the same content as main.tex but is optimized for automated builds
...
\hypersetup{
  ...
  pdfauthor={CTMM-Team},
  pdfsubject={Therapiematerialien mit ausfüllbaren Formulären},
